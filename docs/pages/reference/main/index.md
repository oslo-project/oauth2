...
- [`sendDeviceAuthorizationRequest()`](/reference/main/sendDeviceAuthorizationRequest)
- [`sendTokenRequest()`](/reference/main/sendTokenRequest)
- [`sendTokenRevocationRequest()`](/reference/main/sendTokenRevocationRequest)
