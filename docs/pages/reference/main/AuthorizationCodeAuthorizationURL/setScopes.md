...
Sets the `scope` parameter. Use [`AuthorizationCodeAuthorizationURL.appendScopes()`](/reference/main/AuthorizationCodeAuthorizationURL/appendScopes) to append to existing scopes.
